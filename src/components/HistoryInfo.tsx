    ...
    <img src={USA1} alt="usa1" className={style.HICommonVA} />
     バスケットボールは、長方形のコート上で互いに対峙する 2 つのチーム
      ...
      <p>
        ...
        バスケットボールの国際試合を主催しており、ジョージア のサッカー協会によって管理されています。
        ...
        大会優勝候補相手に僅差の激戦で敗れ、
        <img src={GEO3} alt="GEO3" className={style.HICommonVB} style={{height:"500px",width:screenWidth >=1000 ? "700px" : "380px"}}/>最終的に銀メダルを獲得したリトアニア 81–85。[6] ユーロバスケット 2017
